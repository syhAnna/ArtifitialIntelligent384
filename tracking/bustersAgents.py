...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghost in curr_living_ghost:
            living_ghost_distance.append((ghost, self.distancer.getDistance(pacmanPosition, ghost)))
        ...
        for action in legal:
            movement.append (
                (action, self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, action), min_position)))
